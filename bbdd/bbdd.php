<?php
    function insertar($nombre_imagen, $usuario, $ruta, $tipo, $lon, $lat, $ancho, $alto, $peso, $modelo, $camara){
        $_conexion = mysqli_connect('localhost','root','','test'); //abrir conexión
        if (!$_conexion) //si no se puede establecer la conexión
            die('Error de Conexión (' . mysqli_connect_errno() . ') '. mysqli_connect_error());        

        $sql = "INSERT INTO imagenes(nombre, usuario, foto, tipo, longitud, latitud, ancho, alto, peso, modelo, camara) VALUES('$nombre_imagen', '$usuario', '$ruta', '$tipo', $lon, $lat, $ancho, $alto, $peso, '$modelo', '$camara')";
    ...
    function seleccionartodos($usu){
       ...
       if (!$_conexion) //si no se puede establecer la conexión
        ...
        $sql = "SELECT nombre, foto, ancho, alto, peso, camara, modelo, longitud, latitud FROM imagenes WHERE usuario = '$usu'";
